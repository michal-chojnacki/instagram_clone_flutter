...
import 'package:instagram_clone/features/profile/presentation/user_list_bloc.dart';
import 'package:instagram_clone/features/profile/presentation/user_list_state.dart';
import 'package:instagram_clone/features/profile/presentation/widget/user_list_widget.dart';

class UserListPage extends StatefulWidget {
  static Route route(UserListPageMode mode, User user) {
    return MaterialPageRoute<void>(builder: (_) => UserListPage(mode, user));
  }
